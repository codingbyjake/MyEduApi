...
namespace EduApi.Models {
    ...
    public class Student {
        ...
        public static Student fred = new Student(0, "Fred", "KY", 1300, 3.2m, 1, "fred@email.com", "password");
        public static Student fran = new Student(0, "Fran", "KY", 1410, 3.4m,1, "fran@email.com", "password");
        ...
        public static Student stew = new Student(0, "Stew", "OH", 1420, 3.5m, 1, "stew@email.com", "password");
        public static Student sara = new Student(0, "Sara", "OH", 1419, 3.49m, 1, "sara@email.com", "password");
